para que funcione el proyecto por ahora, hay que tener la base de datos creada en mysql con el nombre moneymate y la tabla dentro que se llam usuarios con los campos, nombre, correo, etc...,
